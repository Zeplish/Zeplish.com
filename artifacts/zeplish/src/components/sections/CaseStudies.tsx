...
const PRODUCT_CARDS: ProductCard[] = [
  {
    ...
    color: "#1a2744",
    industry: "Daycare · US",
    tagline: "Stop tracking documents in spreadsheets.",
    problem: "Spreadsheets updated manually every week, expiry dates missed until urgent, staff and parents chased by phone — no single view of what's missing or expired.",
    outcomes: [
      ...
      "Hours saved on manual follow-ups every week",
    ],
  },
  {
    name: "ClinicOps",
